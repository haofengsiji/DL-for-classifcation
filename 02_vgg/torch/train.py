...
def main():
    ...
    with open('02_vgg/torch/class_indices.json', 'w') as json_file:
    ...
    model_name = "vgg16"
    net = vgg(cfg=model_name, num_classes=2, init_weights=True)
    net.to(device)
    ...
    epochs = 30
    best_acc = 0.0
    save_path = '02_vgg/torch/{}Net.pth'.format(model_name)
